...
# 1. Clean App Configuration Setup
st.set_page_config(page_title="Drought Prediction", layout="wide")

# Crucial: Simple, flat string functions to avoid line 9 markdown crashes
...
# 2. Load the Model and Scaler using Keras 3 version compatibility
@st.cache_resource
def load_artifacts():
...
# 3. Organize your 15 exact feature names into logical UI sections
...
# 4. Construct the array in the EXACT order of your original X dataframe columns
ordered_features = [
